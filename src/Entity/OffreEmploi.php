...
class OffreEmploi
{
    ...
    // ✅ Foreign Key: Link to User (Employer/Farmer)
    #[ORM\ManyToOne(targetEntity: User::class)]
    #[ORM\JoinColumn(nullable: false, onDelete: "CASCADE")]
    private ?User $id_employeur = null;
    ...
    public function getIdEmployeur(): ?User { return $this->id_employeur; }
    public function setIdEmployeur(?User $id_employeur): self { $this->id_employeur = $id_employeur; return $this; }
