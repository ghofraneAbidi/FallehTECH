...
use Symfony\Component\Mailer\MailerInterface;  // Importer MailerInterface
...
class ResetPasswordController extends AbstractController
{
    ...
    private MailerInterface $mailer;  // Déclare la propriété mailer

    private $logger;

    // Injecte le service MailerInterface dans le constructeur
    public function __construct(
        private ResetPasswordHelperInterface $resetPasswordHelper,
        private EntityManagerInterface $entityManager,
        MailerInterface $mailer, // Ajout du MailerInterface
        LoggerInterface $logger
        ) {
        $this->logger = $logger;
        $this->mailer = $mailer;  // Assigne le service à la propriété
    }
