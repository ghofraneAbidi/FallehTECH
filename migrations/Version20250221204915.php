 ...
 */
final class Version20250221204915 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE discount_code (id INT AUTO_INCREMENT NOT NULL, category_id INT NOT NULL, code VARCHAR(10) NOT NULL, discount INT NOT NULL, expiry_date DATETIME NOT NULL, UNIQUE INDEX UNIQ_E997352277153098 (code), INDEX IDX_E997352212469DE2 (category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE produit (id INT AUTO_INCREMENT NOT NULL, categorie_id INT NOT NULL, sous_categorie_id INT NOT NULL, nom VARCHAR(100) NOT NULL, prix NUMERIC(10, 2) NOT NULL, description LONGTEXT NOT NULL, image VARCHAR(255) DEFAULT NULL, is_favorite TINYINT(1) NOT NULL, stock VARCHAR(100) NOT NULL, updated_at DATETIME DEFAULT NULL, INDEX IDX_29A5EC27BCF5E72D (categorie_id), INDEX IDX_29A5EC27365BF48 (sous_categorie_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE discount_code ADD CONSTRAINT FK_E997352212469DE2 FOREIGN KEY (category_id) REFERENCES categorie (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE discount_code DROP FOREIGN KEY FK_E997352212469DE2');
